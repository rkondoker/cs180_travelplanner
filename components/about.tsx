...
const About = () => {
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-blue-400 to-green-600">
      <section className="min-h-[600px] py-16 bg-white/5 flex flex-col justify-center">
      ...
      <section className="min-h-[600px] py-16 bg-white/10 backdrop-blur-sm flex flex-col justify-center">
        <div className="container mx-auto px-8 max-w-4xl">
          <h2 className="text-4xl font-bold text-center text-white mb-12">
            Our Story
          </h2>
          <div className="bg-white/20 p-12 rounded-xl backdrop-blur-sm hover:transform hover:scale-110 transition-transform duration-150">
